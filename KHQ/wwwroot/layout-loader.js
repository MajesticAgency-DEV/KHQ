...
// Ensure all requests include Accept-Language derived from the persisted culture cookie
(function(){
	...
	function getLang(){
		var v = readCookie('.AspNetCore.Culture');
		if(!v){ return 'en'; }
		var m = /c=([^\|]+)/.exec(v);
		return (m && m[1]) ? m[1] : 'en';
	}
    ...
    function attachHandlers(){
        ...
        for (var i=0;i<options.length;i++){
            options[i].addEventListener('click', function(e){
                ...
                // Reflect language immediately in DOM before reload
                if (lang === 'ar'){
                    document.documentElement.setAttribute('dir','rtl');
                    document.documentElement.setAttribute('lang','ar');
                    if (document.body) document.body.classList.add('rtl');
