            ...
            .then(function (html) {
                ...
                try {
                    ...
                    if (url.indexOf('slider.html') !== -1) {
                        ...
                        // Generated by Cursor: fire event when statistics fragment is loaded
                        document.dispatchEvent(new CustomEvent('home:stats-loaded', { detail: { node: node } }));
                    } else if (url.indexOf('blog.html') !== -1) {
                        // Generated by Cursor: fire event when blog fragment is loaded
...
(function () {	
    ...
    // Generated by Cursor: render Statistics from API once the fragment is injected
    ...
    // Generated by Cursor: render Blog from API once the fragment is injected
